// https://www.youtube.com/watch?v=m_HJ3juuFvo&t=4593s
...
class UI {
  ...
  submitBudgetForm() {
    ...
    if (value === '' || value < 0) {
      ...
      const self = this;
      setTimeout(() => self.budgetFeedback.classList.remove('showItem'), 4000);
    } else {
  ...
  totalExpense() {
    ...
    if (this.itemList.length > 0) {
      // reduce
      total = this.itemList.reduce((acc, curr) => acc = acc += curr.amount, 0);
    }
